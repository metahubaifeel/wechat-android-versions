# WeChat 6.0.2 for Android — Official APK Download

**Version `6.0.2`** · **Released December 24, 2014** · **Platform Android**

*[中文说明 ↓](#微信-602-安卓版下载)*

> WeChat 6.0.2 is a historical release of the WeChat Android client.
...
|---|---|---|---|
| universal | `` | `weixin602android520.apk` | [⬇️ Official / 官方](https://dldir1.qq.com/weixin/android/weixin602android520.apk) |
...
WeChat 6.0.2 was published on December 24, 2014. Use the table above if you need to
...
**Nearby versions:** [⬆️ Newer: WeChat 6.1](../6.1/) · [⬇️ Older: WeChat 6.0](../6.0/)
...
> 微信 6.0.2 是微信 Android 客户端的一个历史版本。
...
微信 6.0.2 发布于 2014-12-24。如果你需要回退到该版本，或核对具体构建号，
可直接使用上方表格中的官方直链下载。

> ⚠️ 安装历史版本前请先备份聊天记录。Android 不支持直接降级安装，可能需要先卸载当前版本。

**相关版本：** [⬆️ 更新版本：微信 6.1](../6.1/) · [⬇️ 更早版本：微信 6.0](../6.0/)

# WeChat 6.5.8 for Android — Official APK Download

**Version `6.5.8`** · **Released May 22, 2017** · **Platform Android**

*[中文说明 ↓](#微信-658-安卓版下载)*

> WeChat 6.5.8 is a historical release of the WeChat Android client.
...
|---|---|---|---|
| universal | `` | `weixin658android1060.apk` | [⬇️ Official / 官方](https://dldir1.qq.com/weixin/android/weixin658android1060.apk) |
...
WeChat 6.5.8 was published on May 22, 2017. Use the table above if you need to
...
**Nearby versions:** [⬆️ Newer: WeChat 6.5.10](../6.5.10/) · [⬇️ Older: WeChat 6.5.7](../6.5.7/)
...
> 微信 6.5.8 是微信 Android 客户端的一个历史版本。
...
微信 6.5.8 发布于 2017-05-22。如果你需要回退到该版本，或核对具体构建号，
可直接使用上方表格中的官方直链下载。

> ⚠️ 安装历史版本前请先备份聊天记录。Android 不支持直接降级安装，可能需要先卸载当前版本。

**相关版本：** [⬆️ 更新版本：微信 6.5.10](../6.5.10/) · [⬇️ 更早版本：微信 6.5.7](../6.5.7/)

# WeChat 6.3.8 for Android — Official APK Download

**Version `6.3.8`** · **Released December 8, 2015** · **Platform Android**

*[中文说明 ↓](#微信-638-安卓版下载)*

> WeChat 6.3.8 is a historical release of the WeChat Android client.
...
|---|---|---|---|
| universal | `` | `weixin638android680.apk` | [⬇️ Official / 官方](https://dldir1.qq.com/weixin/android/weixin638android680.apk) |
...
WeChat 6.3.8 was published on December 8, 2015. Use the table above if you need to
...
**Nearby versions:** [⬆️ Newer: WeChat 6.3.9](../6.3.9/) · [⬇️ Older: WeChat 6.3.7](../6.3.7/)

---

# 微信 6.3.8 安卓版下载（官方地址）

**版本号 `6.3.8`** · **发布日期 2015-12-08** · **平台 Android**

> 微信 6.3.8 是微信 Android 客户端的一个历史版本。
...
微信 6.3.8 发布于 2015-12-08。如果你需要回退到该版本，或核对具体构建号，
可直接使用上方表格中的官方直链下载。

> ⚠️ 安装历史版本前请先备份聊天记录。Android 不支持直接降级安装，可能需要先卸载当前版本。

**相关版本：** [⬆️ 更新版本：微信 6.3.9](../6.3.9/) · [⬇️ 更早版本：微信 6.3.7](../6.3.7/)

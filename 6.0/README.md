# WeChat 6.0 for Android — Official APK Download

**Version `6.0`** · **Released October 24, 2014** · **Platform Android**

*[中文说明 ↓](#微信-60-安卓版下载)*

> WeChat 6.0 is a historical release of the WeChat Android client.
...
|---|---|---|---|
| universal | `` | `weixin600android501.apk` | [⬇️ Official / 官方](https://dldir1.qq.com/weixin/android/weixin600android501.apk) |
...
WeChat 6.0 was published on October 24, 2014. Use the table above if you need to
...
**Nearby versions:** [⬆️ Newer: WeChat 6.0.2](../6.0.2/) · [⬇️ Older: WeChat 5.4](../5.4/)
...
微信 6.0 发布于 2014-10-24。如果你需要回退到该版本，或核对具体构建号，
可直接使用上方表格中的官方直链下载。

> ⚠️ 安装历史版本前请先备份聊天记录。Android 不支持直接降级安装，可能需要先卸载当前版本。

**相关版本：** [⬆️ 更新版本：微信 6.0.2](../6.0.2/) · [⬇️ 更早版本：微信 5.4](../5.4/)

# WeChat 7.0.15 for Android — Official APK Download

**Version `7.0.15`** · **Released May 28, 2020** · **Platform Android**

*[中文说明 ↓](#微信-7015-安卓版下载)*

> WeChat 7.0.15 is a historical release of the WeChat Android client.
...
|---|---|---|---|
| universal | `` | `weixin7015android1680.apk` | [⬇️ Official / 官方](https://dldir1.qq.com/weixin/android/weixin7015android1680.apk) |
...
WeChat 7.0.15 was published on May 28, 2020. Use the table above if you need to
...
**Nearby versions:** [⬆️ Newer: WeChat 7.0.16](../7.0.16/) · [⬇️ Older: WeChat 7.0.14](../7.0.14/)
...
> 微信 7.0.15 是微信 Android 客户端的一个历史版本。
...
微信 7.0.15 发布于 2020-05-28。如果你需要回退到该版本，或核对具体构建号，
可直接使用上方表格中的官方直链下载。

> ⚠️ 安装历史版本前请先备份聊天记录。Android 不支持直接降级安装，可能需要先卸载当前版本。

**相关版本：** [⬆️ 更新版本：微信 7.0.16](../7.0.16/) · [⬇️ 更早版本：微信 7.0.14](../7.0.14/)
